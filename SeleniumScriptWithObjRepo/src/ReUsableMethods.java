...
public class ReUsableMethods {
	...
	public static void enterText(WebElement obj, String textVal, String objName) throws IOException{
		if(obj.isDisplayed()){
			...
			Update_Report("Pass", objName +" entered", "text entered");
		}else{
			Update_Report("Fail", objName+ " not entered", objName +"not visible");
	...
	public static void clickButton(WebElement obj,  String objName) throws IOException{
		...
		if(obj.isDisplayed()){
			obj.click();
			Update_Report("Pass", objName + " clicked", " clicked successfully");
			
		}else{
			Update_Report("Fail", objName + " not visible", " not able to click,check your application");
	 ...
	 * last modified:Aug 23 ,2017
	 */
	public static void clearTextBox(WebElement obj, String objName) throws IOException{
		if(obj.isDisplayed()){
			obj.clear();
			Update_Report("Pass ", objName +" cleared", "cleared successfully");
		}
		else{
			Update_Report("Fail ", objName +" is not traceable, please check your application", " unsuccessful");
		}
	}
	
	/* Name of the Method: getText
	...
	public static void getTextInfo(WebElement obj, String objName) throws IOException{
		if(obj.isDisplayed()){
			obj.getText();
			Update_Report("Pass ", objName + "present : ", obj.getText());
		}
		else{
			Update_Report("Fail", objName + " not present", "no error msg dispalyed");
		}
	}
